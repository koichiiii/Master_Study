    ...
    while True:
        ...
        if diff >= 1:
            ...
            for temp in temp_list:
                ...
                # print(f"{temp[0]}について {temp[1]}   -  {ctemp}   =    {difference}")
                # print(comfort_position)
                # length = len(comfort_position)
                # print(comfort_position[length-1])
                if difference == comfort_position[-1][-1]:
                    # comfort_position = [comfort_position + [temp[0].name,[1,1,1],difference]]
